...
public class MIDIFeatureProcessor
{
	...
	MIDIIntermediateRepresentations intermediateFeature;
     ...
     public MIDIIntermediateRepresentations GetMidiIntermediate()
     {
          ...
          boolean[] features_to_save_among_all )
     {
          ...
          // Add dependencies to dependencies and if any features are not mar ked for
     ...
     throws Exception
     {
    	 ...
    	 System.out.println(feature_extractors.length);
          ...
          for (int win = 0; win < windows.length; win++)
          {
               ...
               intermediateFeature = intermediate;
